...
public class ContactsListActivity extends FragmentActivity implements
    ...
    StringAppService appService = null;
    ...
    protected void onStart() {
        super.onStart();
        /*if(appService==null)
        	bindService(new Intent(this, StringAppService.class), mConnection, Context.BIND_AUTO_CREATE);*/
      }
    @Override
    ...
    /*private ServiceConnection mConnection = new ServiceConnection() {
        ...
        public void onServiceConnected(ComponentName className, IBinder binder) {
        	appService = ((StringAppService.AppServiceBinder) binder).getService();
